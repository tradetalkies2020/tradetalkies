...
class OtherProfile extends StatefulWidget {
  OtherProfile({Key key, this.name, this.username, this.Follow})
      : super(key: key);
...
class _OtherProfileState extends State<OtherProfile> {
  ...
  Future getPosts() async {
    ...
    try {
      ...
      posts =
          await Provider.of<UserAuth>(context, listen: false).getuserPosts('00000');
      print(feeds);
      feeds = posts['content'];
                  ...
                  Row(
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(follow ? "Following" : "+ Follow",
                                style: TextStyle(
                                    color:
                                        !follow ? Colors.black : Colors.white,
                                    fontFamily: 'Inter',
                                    fontSize: 14.0,
                                    letterSpacing: 0.15,
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.push(
                context, MaterialPageRoute(builder: (context) => ChatScreen(name:widget.name,path:'assets/images/avatar.png',fromSearch: false,)));
                        },
                        child: Container(
                          decoration: BoxDecoration(
                              borderRadius:
